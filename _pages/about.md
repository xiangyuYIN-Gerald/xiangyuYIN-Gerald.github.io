...
1. **CeTAD: Towards Certified Toxicity-Aware Distance in Vision Language Models**
   *arXiv preprint arXiv:2503.10661*&nbsp; &nbsp; <br>
   **Authors**: **Xiangyu, Yin; Jiaxu, Liu; Zhen, Chen; Jinwei, Hu; Yi, Dong; Xiaowei, Huang; Wenjie, Ruan

1. **FALCON: Fine-grained Activation Manipulation by Contrastive Orthogonal Unalignment for Large Language Model**
   *arXiv preprint arXiv:2502.01472*&nbsp;&nbsp;<br>
   **Authors**: Jinwei, Hu; Zhenglin, Huang; Xiangyu, Yin; Wenjie, Ruan; Guangliang, Cheng; Yi, Dong; Xiaowei, Huang

1. **A Black-Box Evaluation Framework for Semantic Robustness in Bird's Eye View Detection**
...
2. **Continuous Geometry-Aware Graph Diffusion via Hyperbolic Neural PDE**  
...
3. **Tiny Refinements Elicit Resilience: Toward Efficient Prefix-Model Against LLM Red-Teaming**  
...
4. **Boosting Adversarial Training via Fisher-Rao Norm-based Regularization**  
...
5. **Representation-Based Robustness in Goal-Conditioned Reinforcement Learning**  
   *Proceedings of the AAAI Conference on Artificial Intelligence, 2024*&nbsp;&nbsp;<br>
...
6. **Dimba: discretely masked black-box attack in single object tracking**  
   *Machine Learning, 2024*&nbsp;&nbsp;<br>
   <!-- ([paper](https://openreview.net/pdf?id=XO4tvoyQd4_)) -->
   **Authors**: **Xiangyu, Yin**; Wenjie, Ruan; Jonathan, Fieldsend 

7. **ODE4ViTRobustness: A tool for understanding adversarial robustness of Vision Transformers**  
...
8. **Temple: Learning template of transitions for sample efficient multi-task rl**  
